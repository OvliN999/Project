...
import songA from "./music/Surma.mp3";
import songB from "./music/Perfect.mp3";
import songC from "./music/Ishq hai.mp3";
...
// Playlist song names
const playlist = ["Surma", "Perfect", "Ishq hai"];
        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <div className="relative mx-auto">
            ...
            <motion.button
              ...
              onClick={onComplete}
            >
              I wrote something special for you, Sakku❤️
            </motion.button>
          </div>
        </div>
      </div>

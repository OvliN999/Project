...
import bgMusic from './components/music/Surma.mp3';
...
function App() {
  ...
  const messages = [
    "Hey Sakku✨ It's your day to shine!",
  ...
  return (
    <div className="relative">
      ...
      {/* Footer with made-with message */}
      <footer className="fixed bottom-4 right-4 z-50 flex items-center space-x-2 bg-white/30 backdrop-blur-sm px-4 py-2 rounded-full shadow-md border border-white/40">
        <Heart className="text-red-500 w-4 h-4" />
        <span className="text-sm md:text-base text-white font-medium">from Prashant</span>
      </footer>
